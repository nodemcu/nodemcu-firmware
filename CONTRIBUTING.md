...
This is just one way of doing things. If you are Windows or Mac user you may also have a look at [GitHub Desktop](https://desktop.github.com/) which lets you do most of the steps with you mouse. If you're proficient in Git matters you're free to choose your own. If you want to read more then the [GitHub chapter in the Git book](http://git-scm.com/book/en/v2/GitHub-Contributing-to-a-Project#The-GitHub-Flow) is a way to start. [GitHub's own documentation](https://help.github.com/categories/collaborating-with-issues-and-pull-requests/) contains a wealth of information as well.
