...
static int ICACHE_FLASH_ATTR bme280_forced_mode(lua_State* L) {
...
static int ICACHE_FLASH_ATTR bme280_lua_qfe2qnh(lua_State* L) {
	...
	lua_pushinteger(L, (int32_t)(qnh + 0.0005));
	return 1;
}
...
static int ICACHE_FLASH_ATTR bme280_lua_altitude(lua_State* L) {
	...
	lua_pushinteger(L, (int32_t)(h + (((h<0)?-1:(h>0)) * 0.005)));
	return 1;
}
...
static int ICACHE_FLASH_ATTR bme280_lua_dewpoint(lua_State* L) {
	...
	lua_pushinteger(L, (int32_t)(d + (((d<0)?-1:(d>0)) * 0.005)));
	return 1;
}
