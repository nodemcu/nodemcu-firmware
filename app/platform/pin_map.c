...
#endif
#else
uint32_t pin_mux[GPIO_PIN_NUM] = {PAD_XPD_DCDC_CONF,  PERIPHS_IO_MUX_GPIO4_U,  PERIPHS_IO_MUX_GPIO5_U, 	 PERIPHS_IO_MUX_GPIO0_U,
...
uint8_t pin_num[GPIO_PIN_NUM] = {16, 4, 5, 0,
								  2,  14,  12, 13,
								  15,  3,  1, 9,
								  10};

uint8_t pin_func[GPIO_PIN_NUM] = {0, FUNC_GPIO4, FUNC_GPIO5, FUNC_GPIO0,
