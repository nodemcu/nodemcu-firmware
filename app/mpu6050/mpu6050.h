...
//#define MPU6050_DEBUG_ON
//#define MPU6050_ERROR

#if defined(MPU6050_DEBUG_ON)
  static const char log_prefix[] = "MPU6050: ";
  #define MPU6050_DEBUG(format, ...) dbg_printf("%s"format"\n", log_prefix, ##__VA_ARGS__)
#else
  #define MPU6050_DEBUG(...)
#endif
#if defined(MPU6050_ERROR)
  #define MPU6050_ERR(format, ...) NODE_ERR("%s"format"\n", log_prefix, ##__VA_ARGS__)
#else
  #define MPU6050_ERR(...)
#endif
