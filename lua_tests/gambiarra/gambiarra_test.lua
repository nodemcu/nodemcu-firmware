...
local function load_tests()
  ...
  metatest('ok without a message', function()
    ok(1 == 1)
    ok(1 == 2)
  end, {'gambiarra_test.lua:31'}, {'gambiarra_test.lua:32'})

  metatest('nok without a message', function()
    nok(1 == "")
    nok(1 == 1)
  end, {'gambiarra_test.lua:36'}, {'gambiarra_test.lua:37'})
  ...
  metatest('fail with incorrect errormessage', function()
    ...
    ok(true, 'unreachable code')
        ...
        'expected errormessage "gambiarra_test.lua:169: my error" to contain "different error"'})

  metatest('fail with incorrect errormessage default message', function()
    fail(function() error("my error") end, "different error")
    ok(true, 'unreachable code')
  end, {}, {'gambiarra_test.lua:175',
        'expected errormessage "gambiarra_test.lua:175: my error" to contain "different error"'})
