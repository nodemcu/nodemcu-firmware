...
| :----- | :-------------------- | :---------- | :------ |
| 2015-02-05 | [Till Klocke](https://github.com/dereulenspiegel), [Thomas Soëte](https://github.com/Alkorin) | [Till Klocke](https://github.com/dereulenspiegel) | [Felix Penzlin](https://github.com/FelixPe) | [ws2812.c](../../../app/modules/ws2812.c)|
...
#### Example
```lua
buffer:fillHSI{{168,1023,1023}} -- fill the buffer with cyan for a RGB strip
```
## ws2812.buffer:fade()
