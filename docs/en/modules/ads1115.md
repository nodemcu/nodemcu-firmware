...
This module supports up to 4 converter devices connected to I²C bus. The devices of different types can be mixed.
...
#### Syntax
`volt, volt_dec, adc = ads1115.read(ADDRESS)`
...
i2c.setup(ads1115.ADDR_GND, sda, scl, i2c.SLOW)
ads1115.reset()
ads1115.setup(ads1115.ADDR_GND, ads1115.ADS1115)

-- continuous mode
ads1115.setting(ads1115.ADDR_GND, ads1115.GAIN_6_144V, ads1115.DR_128SPS, ads1115.SINGLE_0, ads1115.CONTINUOUS)
-- read adc result with read()
volt, volt_dec, adc = ads1115.read(ads1115.ADDR_GND)
print(volt, volt_dec, adc)

-- comparator
ads1115.setting(ads1115.ADDR_GND, ads1115.GAIN_6_144V, ads1115.DR_128SPS, ads1115.SINGLE_0, ads1115.CONTINUOUS, ads1115.COMP_1CONV, 1000, 2000)
...
## ads1115.reset()
Reset all devices on I²C interface.
...
#### Syntax
`ads1115.setting(ADDRESS, GAIN, SAMPLES, CHANNEL, MODE[, CONVERSION_RDY][, COMPARATOR, THRESHOLD_LOW, THRESHOLD_HI[,COMP_MODE]])`
...
ads1115.reset()
ads1115.setup(ads1115.ADDR_GND, ads1115.ADS1015)

ads1115.setting(ads1115.ADDR_GND, ads1115.GAIN_6_144V, ads1115.DR_3300SPS, ads1115.SINGLE_0, ads1115.SINGLE_SHOT)
```
...
#### Syntax
`ads1115.setup(ADDRESS, DEVICE_TYPE)`
...
- `ADDRESS` - I²C address of a device
	...
	* `ads1115.ADDR_SCL`
- `DEVICE_TYPE`
	* `ads1115.ADS1115` (can be used for ADS1113 and ADS1114)
	* `ads1115.ADS1015` (can be used for ADS1013 and ADS1014)
...
ads1115.setup(ads1115.ADDR_GND, ads1115.ADS1015)
ads1115.setup(ads1115.ADDR_VDD, ads1115.ADS1115)
```
...
#### Syntax
`ads1115.startread(ADDRESS, [CALLBACK])`
...
-- single shot
ads1115.setting(ads1115.ADDR_VDD, ads1115.GAIN_6_144V, ads1115.DR_128SPS, ads1115.SINGLE_0, ads1115.SINGLE_SHOT)
-- start adc conversion and get result in callback after conversion is ready
ads1115.startread(ads1115.ADDR_VDD, function(volt, volt_dec, adc) print(volt, volt_dec, adc) end)

-- conversion ready
ads1115.setting(ads1115.ADDR_VDD, ads1115.GAIN_6_144V, ads1115.DR_128SPS, ads1115.SINGLE_0, ads1115.SINGLE_SHOT, ads1115.CONV_RDY_1)
...
ads1115.startread(ads1115.ADDR_VDD)
```
